    ...
    return (
        <div className="">
            <div className="px-16 pt-16">
                ...
                <p className="mt-3">Internship: Implementation of a web
                    application as part of a 4 person team
                    based on UI concepts provided via
                    Figma:</p>
                ...
                <ul className="list-disc mt-3 ml-8">
                    ...
                    <li className="">implementation of frontend and backend with the React Framework: Next.js</li>
                    <li className="">configuration of S3-Bucket on AWS for file upload</li>
            ...
            <div className="px-16 pt-16">
                ...
                <p className="mt-3">Coding Bootcamp - intensive training concentrating on in-demand coding languages and project work methods</p>

                <h2 className="mt-6 font-bold">Audio Visual Designer</h2>
                <h3 className="">L4-Akademy</h3>
                <h4 className="">2009 Sep – 2012 Sep | Berlin, Germany</h4>
                <p className="mt-3">Apprenticeship focused on earning skills in video production
                    (camera-, sound and light technique and editing/postproduction)</p>
            </div>
        </div>
    );
}
